...
public void keyPressed() //Keyboard buttons to move box paddle
{
  Event event;
...
public void keyReleased() //Key release very important!
{
  Event event;
...
public final String MAIN_SERVER_IP = "127.0.0.1"; //Change Server IP Here!
